...
button2 = Button(root, text='Виконати (файл)', width=27, height=5, bg='lavender', fg='purple4', font="terminal 15",
                 relief=GROOVE, overrelief=RIDGE, bd=4)
label_res = Label(root, width=25, height=5, bg='LightYellow2', fg='purple4', font="terminal 15")
label_n = Label(root, text='Введіть розмір масиву:', width=25, height=5, bg='LightYellow2', fg='purple4',
                font="terminal 15")
label_r = Label(root, text='Час сортування:', width=25, height=5, bg='LightYellow2', fg='purple4', font="terminal 15")
